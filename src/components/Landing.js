...
function Landing() {
    return (
        <>
           <section className="flex h-screen flex-col items-center px-6 lg:px-32 bg-coral justify-center ">
                <main id='landing' className="w-full md:w-9/12 xl:w-8/12">

                    <h1 className="text-4xl md:text-6xl lg:text-9xl md:p-3 font-kalam font-bold text-lavender text-center">
                        Q8
                    </h1>
