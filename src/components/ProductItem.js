        ...
        <Toaster />
            <div className="max-w-sm rounded-lg shadow-lg bg-white">
                ...
                <div className="p-5">
                    ...
                    <button onClick={Add} className="inline-flex items-center p-2 m-1 text-sm font-medium text-center text-white bg-pink-800 rounded-lg hover:bg-lavender focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                        Add To Cart
                        <svg className="ml-2 -mr-1 w-4 h-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                    </button>
                    <Link to={"product/"+props.id} className="inline-flex items-center p-2 m-1 text-sm font-medium text-center text-white bg-pink-800 rounded-lg hover:bg-lavender focus:ring-4 focus:outline-none focus:ring-blue-300 ">
                        More Info
                    </Link>
                </div>
            </div>
